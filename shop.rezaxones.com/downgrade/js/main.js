	...
	$(document).ready(function() {
        ...
        /* $('.contact-form-wrapper button').click(function(e) {
            ...
            if($( 'input.form-control' ).val() == ''){
                ...
                $(".list-error").html('<p><strong>Lá»—i! </strong>ChÆ°a nháº­p tÃªn</p><p><strong>Lá»—i! </strong>ChÆ°a nháº­p tÃªn</p>');
                setTimeout(() => {
                    $(".list-error").hide();
                },3000);
            } else {
        ...
        /* $('.box-reply .btn-close').on('click', function() {
            if (confirm('Báº¡n cháº¯n cháº¯n muá»‘n Ä‘Ã³ng tháº£o luáº­n?')) {
                ...
                if (!support_id) {
                    toastr.warning('KhÃ´ng tÃ¬m tháº¥y cuá»™c tháº£o luáº­n !');
                    return false;
                }
